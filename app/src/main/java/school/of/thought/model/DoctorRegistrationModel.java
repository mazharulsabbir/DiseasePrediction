...
public class DoctorRegistrationModel {
    ...
    public DoctorRegistrationModel(String name, String drsignation, String special_area, String email, String mobile, String image, List<DoctorChamberListModel> chamber_list) {
        this.name = name;
